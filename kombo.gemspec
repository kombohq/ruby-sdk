...
Gem::Specification.new do |s|
  ...
  s.summary     = ''
  s.homepage    = 'https://github.com/kombohq/ruby-sdk.git'
  s.description = 'The official Ruby SDK for the Kombo Unified API'
  s.authors     = ['Kombo Technologies GmbH']
  s.metadata    = {
    'homepage_uri' => 'https://github.com/kombohq/ruby-sdk.git',
    'documentation_uri' => 'https://github.com/kombohq/ruby-sdk.git',
