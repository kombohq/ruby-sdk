    ...
    module Operations
      ...
      class PostPassthroughToolApiResponse
        ...
        def initialize(content_type:, status_code:, raw_response:, post_passthrough_tool_api_positive_response: nil)
          ...
          @post_passthrough_tool_api_positive_response = post_passthrough_tool_api_positive_response
        end
        ...
        def ==(other)
          ...
          return false unless @post_passthrough_tool_api_positive_response == other.post_passthrough_tool_api_positive_response
          true
        end
      end
    end
