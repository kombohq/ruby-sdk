...
module OpenApiSDK
  module Models
    module Operations
      ...
      class PostAtsApplicationsApplicationIdRejectRequest
        extend T::Sig
        ...
        field :body, Models::Components::PostAtsApplicationsApplicationIdRejectRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(application_id: ::String, body: Models::Components::PostAtsApplicationsApplicationIdRejectRequestBody, integration_id: T.nilable(::String)).void }
