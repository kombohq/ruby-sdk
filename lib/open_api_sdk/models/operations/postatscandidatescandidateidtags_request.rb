  ...
  module Models
    module Operations
      ...
      class PostAtsCandidatesCandidateIdTagsRequest
        ...
        field :body, Models::Components::PostAtsCandidatesCandidateIdTagsRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(candidate_id: ::String, body: Models::Components::PostAtsCandidatesCandidateIdTagsRequestBody, integration_id: T.nilable(::String)).void }
