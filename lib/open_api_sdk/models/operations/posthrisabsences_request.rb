  ...
  module Models
    module Operations
      ...
      class PostHrisAbsencesRequest
        ...
        field :body, Models::Components::PostHrisAbsencesRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(body: Models::Components::PostHrisAbsencesRequestBody, integration_id: T.nilable(::String)).void }
