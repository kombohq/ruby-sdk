  ...
  module Models
    module Operations
      ...
      class PostHrisAbsencesRequest
        ...
        field :body, Models::Shared::PostHrisAbsencesRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(body: Models::Shared::PostHrisAbsencesRequestBody, integration_id: T.nilable(::String)).void }
