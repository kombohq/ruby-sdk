  ...
  module Models
    module Operations
      ...
      class PostAtsApplicationsApplicationIdResultLinksRequest
        ...
        field :body, Models::Components::PostAtsApplicationsApplicationIdResultLinksRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(application_id: ::String, body: Models::Components::PostAtsApplicationsApplicationIdResultLinksRequestBody, integration_id: T.nilable(::String)).void }
