  ...
  module Models
    module Operations
      ...
      class GetAtsCandidatesRequest
        ...
        field :first_name, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'first_name', 'style': 'form', 'explode': true } }
        ...
        field :last_name, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'last_name', 'style': 'form', 'explode': true } }
        ...
        sig { params(integration_id: T.nilable(::String), cursor: T.nilable(::String), updated_after: T.nilable(::DateTime), ids: T.nilable(T::Array[::String]), remote_ids: T.nilable(T::Array[::String]), email: T.nilable(::String), job_ids: T.nilable(T::Array[::String]), first_name: T.nilable(::String), last_name: T.nilable(::String), page_size: T.nilable(::Integer), include_deleted: T.nilable(T::Boolean), ignore_unsupported_filters: T.nilable(T::Boolean)).void }
        def initialize(integration_id: nil, cursor: nil, updated_after: nil, ids: nil, remote_ids: nil, email: nil, job_ids: nil, first_name: nil, last_name: nil, page_size: 100, include_deleted: false, ignore_unsupported_filters: false)
