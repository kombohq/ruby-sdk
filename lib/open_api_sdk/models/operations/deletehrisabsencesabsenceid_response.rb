    ...
    module Operations
      ...
      class DeleteHrisAbsencesAbsenceIdResponse
        ...
        def initialize(content_type:, status_code:, raw_response:, delete_hris_absences_absence_id_positive_response: nil)
          ...
          @delete_hris_absences_absence_id_positive_response = delete_hris_absences_absence_id_positive_response
        end
        ...
        def ==(other)
          ...
          return false unless @delete_hris_absences_absence_id_positive_response == other.delete_hris_absences_absence_id_positive_response
          true
        end
      end
    end
