    ...
    module Operations
      ...
      class PutAtsApplicationsApplicationIdStageResponse
        ...
        def initialize(content_type:, status_code:, raw_response:, put_ats_applications_application_id_stage_positive_response: nil)
          ...
          @put_ats_applications_application_id_stage_positive_response = put_ats_applications_application_id_stage_positive_response
        end
        ...
        def ==(other)
          ...
          return false unless @put_ats_applications_application_id_stage_positive_response == other.put_ats_applications_application_id_stage_positive_response
          true
        end
      end
    end
