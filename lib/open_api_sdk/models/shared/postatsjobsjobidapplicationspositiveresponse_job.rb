...
module OpenApiSDK
  module Models
    module Shared
      ...
      class PostAtsJobsJobIdApplicationsPositiveResponseJob
        extend T::Sig
        ...
        sig { params(id: ::String, remote_id: ::String, name: T.nilable(::String)).void }
        def initialize(id:, remote_id:, name: nil)
          @id = id
          @remote_id = remote_id
          @name = name
        end
