  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesCandidateIdResultLinksRequestBody
        ...
        field :details, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesCandidateIdResultLinksRequestBodyDetails), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('details') } }
        # Additional fields that we will pass through to specific ATS systems.
        field :remote_fields, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesCandidateIdResultLinksRequestBodyRemoteFields), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('remote_fields') } }

        sig { params(label: ::String, url: ::String, details: T.nilable(Models::Shared::PostAtsCandidatesCandidateIdResultLinksRequestBodyDetails), remote_fields: T.nilable(Models::Shared::PostAtsCandidatesCandidateIdResultLinksRequestBodyRemoteFields)).void }
