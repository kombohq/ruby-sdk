  ...
  module Models
    module Shared
      ...
      class Feature
        ...
        field :coverage_status, Models::Shared::FeatureCoverageStatus, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('coverage_status'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::FeatureCoverageStatus, false) } }
