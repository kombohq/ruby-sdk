  ...
  module Models
    module Shared
      ...
      class Schema2Date
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::Schema2UnifiedKey3), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Shared::Schema2UnifiedKey3, true) } }
