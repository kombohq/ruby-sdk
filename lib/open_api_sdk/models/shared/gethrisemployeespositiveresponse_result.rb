  ...
  module Models
    module Shared
      ...
      class GetHrisEmployeesPositiveResponseResult
        ...
        field :employments, Crystalline::Array.new(Models::Shared::Employment), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employments'), required: true } }

        field :time_off_balances, Crystalline::Array.new(Models::Shared::TimeOffBalance), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('time_off_balances'), required: true } }

        field :groups, Crystalline::Array.new(Models::Shared::Group), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('groups'), required: true } }
        ...
        field :manager, Crystalline::Nilable.new(Models::Shared::Manager), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('manager'), required: true } }

        field :legal_entity, Crystalline::Nilable.new(Models::Shared::LegalEntity), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('legal_entity'), required: true } }

        field :work_location, Crystalline::Nilable.new(Models::Shared::WorkLocation), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('work_location'), required: true } }
        ...
        field :gender, Crystalline::Nilable.new(Models::Shared::GetHrisEmployeesPositiveResponseGender), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('gender'), 'decoder': Utils.enum_from_string(Models::Shared::GetHrisEmployeesPositiveResponseGender, true) } }
        # The employee’s ethnicity. In rare cases where we can’t find a clear mapping, the original string is passed through.
        field :ethnicity, Crystalline::Nilable.new(Models::Shared::Ethnicity), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('ethnicity'), 'decoder': Utils.enum_from_string(Models::Shared::Ethnicity, true) } }
        ...
        field :marital_status, Crystalline::Nilable.new(Models::Shared::MaritalStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('marital_status'), 'decoder': Utils.enum_from_string(Models::Shared::MaritalStatus, true) } }
        ...
        field :employment_status, Crystalline::Nilable.new(Models::Shared::EmploymentStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_status'), 'decoder': Utils.enum_from_string(Models::Shared::EmploymentStatus, true) } }
        ...
        # 
        #  In rare cases where we can’t find a clear mapping, the original string is passed through.
        field :employment_type, Crystalline::Nilable.new(Models::Shared::GetHrisEmployeesPositiveResponseEmploymentType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_type'), 'decoder': Utils.enum_from_string(Models::Shared::GetHrisEmployeesPositiveResponseEmploymentType, true) } }
        # The employee’s home address.
        field :home_address, Crystalline::Nilable.new(Models::Shared::HomeAddress), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('home_address') } }
        # The employee’s bank accounts.
        field :bank_accounts, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::BankAccount)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('bank_accounts') } }
