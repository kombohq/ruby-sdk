  ...
  module Models
    module Shared
      ...
      class GetAtsOffersPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetAtsOffersPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetAtsOffersPositiveResponseResult], next_: T.nilable(::String)).void }
