  ...
  module Models
    module Shared
      ...
      class Schema2Checkbox
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::Schema2UnifiedKey5), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Shared::Schema2UnifiedKey5, true) } }
