  ...
  module Models
    module Shared
      ...
      class GetAtsApplicationsApplicationIdAttachmentsPositiveResponse
        ...
        field :data, Models::Shared::GetAtsApplicationsApplicationIdAttachmentsPositiveResponseData, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('data'), required: true } }
        # These are the interaction warnings that are shown in the dashboard. They are meant to provide debug information to you. We recommend logging them to the console.
        field :warnings, Crystalline::Array.new(Models::Shared::GetAtsApplicationsApplicationIdAttachmentsPositiveResponseWarning), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('warnings'), required: true } }
