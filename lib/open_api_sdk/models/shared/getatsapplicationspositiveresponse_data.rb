  ...
  module Models
    module Shared
      ...
      class GetAtsApplicationsPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetAtsApplicationsPositiveResponseResult), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('results'), required: true } }
