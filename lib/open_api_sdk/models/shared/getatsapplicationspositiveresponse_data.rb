  ...
  module Models
    module Shared
      ...
      class GetAtsApplicationsPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetAtsApplicationsPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetAtsApplicationsPositiveResponseResult], next_: T.nilable(::String)).void }
