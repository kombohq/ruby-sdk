  ...
  module Models
    module Shared
      ...
      class PropertiesText
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::GetHrisEmployeesFormPositiveResponseUnifiedKey1), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Shared::GetHrisEmployeesFormPositiveResponseUnifiedKey1, true) } }
