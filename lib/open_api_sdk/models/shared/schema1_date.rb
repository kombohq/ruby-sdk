  ...
  module Models
    module Shared
      ...
      class Schema1Date
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::Schema1UnifiedKey3), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Shared::Schema1UnifiedKey3, true) } }
