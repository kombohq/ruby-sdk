  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesRequestBodyLocationData
        ...
        field :country_region_reference, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesRequestBodyCountryRegionReference), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Country_Region_Reference') } }

        field :country_city_reference, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesRequestBodyCountryCityReference), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Country_City_Reference') } }

        sig { params(address_line_1: T.nilable(::String), address_line_2: T.nilable(::String), region_subdivision_1: T.nilable(::String), country_region_reference: T.nilable(Models::Shared::PostAtsCandidatesRequestBodyCountryRegionReference), country_city_reference: T.nilable(Models::Shared::PostAtsCandidatesRequestBodyCountryCityReference)).void }
