  ...
  module Models
    module Shared
      ...
      class PostAtsJobsJobIdApplicationsRequestBodyWorkday
        ...
        field :candidate_data, Crystalline::Nilable.new(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyCandidateData), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Candidate_Data') } }
        ...
        sig { params(candidate_data: T.nilable(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyCandidateData), override_source_reference_wid: T.nilable(::String)).void }
