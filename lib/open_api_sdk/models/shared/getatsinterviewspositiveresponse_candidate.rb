  ...
  module Models
    module Shared
      ...
      class GetAtsInterviewsPositiveResponseCandidate
        ...
        field :email_addresses, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::GetAtsInterviewsPositiveResponseEmailAddress)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('email_addresses') } }

        sig { params(id: ::String, remote_id: ::String, first_name: T.nilable(::String), last_name: T.nilable(::String), email_addresses: T.nilable(T::Array[Models::Shared::GetAtsInterviewsPositiveResponseEmailAddress])).void }
