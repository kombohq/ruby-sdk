  ...
  module Models
    module Shared
      ...
      class GetAtsCandidatesPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetAtsCandidatesPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetAtsCandidatesPositiveResponseResult], next_: T.nilable(::String)).void }
