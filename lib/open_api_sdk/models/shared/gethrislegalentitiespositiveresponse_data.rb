  ...
  module Models
    module Shared
      ...
      class GetHrisLegalEntitiesPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetHrisLegalEntitiesPositiveResponseResult), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('results'), required: true } }
