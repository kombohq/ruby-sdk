  ...
  module Models
    module Shared
      ...
      class GetToolsCategoryPositiveResponseWriteAction
        ...
        field :coverage_status, Models::Shared::GetToolsCategoryPositiveResponseWriteActionCoverageStatus, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('coverage_status'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GetToolsCategoryPositiveResponseWriteActionCoverageStatus, false) } }
