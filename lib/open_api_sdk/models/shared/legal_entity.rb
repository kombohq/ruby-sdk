  ...
  module Models
    module Shared
      ...
      class LegalEntity
        ...
        field :address, Crystalline::Nilable.new(Models::Shared::LegalEntityAddress), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('address') } }

        sig { params(id: ::String, remote_id: T.nilable(::String), name: T.nilable(::String), address: T.nilable(Models::Shared::LegalEntityAddress)).void }
