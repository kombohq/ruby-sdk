  ...
  module Models
    module Shared
      ...
      class Group
        ...
        # Type of the group.
        field :type, Crystalline::Nilable.new(Models::Shared::GroupType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GroupType, false) } }
