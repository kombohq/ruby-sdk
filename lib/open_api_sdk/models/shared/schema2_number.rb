  ...
  module Models
    module Shared
      ...
      class Schema2Number
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::Schema2UnifiedKey2), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Shared::Schema2UnifiedKey2, true) } }
