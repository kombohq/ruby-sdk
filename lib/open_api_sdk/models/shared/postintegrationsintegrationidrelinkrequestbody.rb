  ...
  module Models
    module Shared
      ...
      class PostIntegrationsIntegrationIdRelinkRequestBody
        ...
        field :link_type, Crystalline::Nilable.new(Models::Shared::PostIntegrationsIntegrationIdRelinkRequestBodyLinkType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('link_type'), 'decoder': Utils.enum_from_string(Models::Shared::PostIntegrationsIntegrationIdRelinkRequestBodyLinkType, true) } }
        # Language of the connection flow UI.
        field :language, Crystalline::Nilable.new(Models::Shared::PostIntegrationsIntegrationIdRelinkRequestBodyLanguage), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('language'), 'decoder': Utils.enum_from_string(Models::Shared::PostIntegrationsIntegrationIdRelinkRequestBodyLanguage, true) } }
