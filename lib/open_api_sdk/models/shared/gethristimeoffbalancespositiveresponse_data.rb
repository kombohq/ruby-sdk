  ...
  module Models
    module Shared
      ...
      class GetHrisTimeOffBalancesPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetHrisTimeOffBalancesPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetHrisTimeOffBalancesPositiveResponseResult], next_: T.nilable(::String)).void }
