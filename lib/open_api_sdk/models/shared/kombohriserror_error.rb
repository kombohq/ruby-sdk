  ...
  module Models
    module Shared
      ...
      class KomboHrisErrorError
        ...
        field :code, Crystalline::Nilable.new(Models::Shared::KomboHrisErrorCode), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::KomboHrisErrorCode, false) } }
