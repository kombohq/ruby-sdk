  ...
  module Models
    module Shared
      ...
      class Employment
        ...
        field :pay_period, Crystalline::Nilable.new(Models::Shared::GetHrisEmployeesPositiveResponsePayPeriod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_period'), 'decoder': Utils.enum_from_string(Models::Shared::GetHrisEmployeesPositiveResponsePayPeriod, true) } }
        ...
        field :pay_frequency, Crystalline::Nilable.new(Models::Shared::GetHrisEmployeesPositiveResponsePayFrequency), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_frequency'), 'decoder': Utils.enum_from_string(Models::Shared::GetHrisEmployeesPositiveResponsePayFrequency, true) } }
        ...
        field :employment_type, Crystalline::Nilable.new(Models::Shared::EmploymentEmploymentType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_type'), 'decoder': Utils.enum_from_string(Models::Shared::EmploymentEmploymentType, true) } }

        sig { params(id: ::String, employee_id: ::String, changed_at: ::DateTime, remote_id: T.nilable(::String), job_title: T.nilable(::String), pay_rate: T.nilable(::Float), pay_currency: T.nilable(::String), effective_date: T.nilable(::DateTime), remote_deleted_at: T.nilable(::DateTime), custom_fields: T.nilable(T::Hash[Symbol, ::Object]), pay_period: T.nilable(Models::Shared::GetHrisEmployeesPositiveResponsePayPeriod), pay_frequency: T.nilable(Models::Shared::GetHrisEmployeesPositiveResponsePayFrequency), employment_type: T.nilable(Models::Shared::EmploymentEmploymentType)).void }
