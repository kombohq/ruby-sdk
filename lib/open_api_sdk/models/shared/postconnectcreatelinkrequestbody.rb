  ...
  module Models
    module Shared
      ...
      class PostConnectCreateLinkRequestBody
        ...
        field :integration_category, Crystalline::Nilable.new(Models::Shared::PostConnectCreateLinkRequestBodyIntegrationCategory), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('integration_category'), 'decoder': Utils.enum_from_string(Models::Shared::PostConnectCreateLinkRequestBodyIntegrationCategory, true) } }
        # Pre-define a tool this integration link can be used for.
        field :integration_tool, Crystalline::Nilable.new(Models::Shared::IntegrationTool), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('integration_tool'), 'decoder': Utils.enum_from_string(Models::Shared::IntegrationTool, true) } }
        ...
        field :link_type, Crystalline::Nilable.new(Models::Shared::PostConnectCreateLinkRequestBodyLinkType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('link_type'), 'decoder': Utils.enum_from_string(Models::Shared::PostConnectCreateLinkRequestBodyLinkType, true) } }
        # Language of the connection flow UI.
        field :language, Crystalline::Nilable.new(Models::Shared::PostConnectCreateLinkRequestBodyLanguage), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('language'), 'decoder': Utils.enum_from_string(Models::Shared::PostConnectCreateLinkRequestBodyLanguage, true) } }
