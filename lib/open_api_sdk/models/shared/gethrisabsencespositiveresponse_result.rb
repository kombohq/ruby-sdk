  ...
  module Models
    module Shared
      ...
      class GetHrisAbsencesPositiveResponseResult
        ...
        field :unit, Crystalline::Nilable.new(Models::Shared::GetHrisAbsencesPositiveResponseUnit), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unit'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GetHrisAbsencesPositiveResponseUnit, false) } }
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::GetHrisAbsencesPositiveResponseType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true } }
        # The absence’s current status. In rare cases where we can’t find a clear mapping, the original string is passed through.
        field :status, Crystalline::Nilable.new(Models::Shared::GetHrisAbsencesPositiveResponseStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::GetHrisAbsencesPositiveResponseStatus, true) } }
