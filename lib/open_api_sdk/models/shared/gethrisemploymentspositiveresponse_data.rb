  ...
  module Models
    module Shared
      ...
      class GetHrisEmploymentsPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetHrisEmploymentsPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetHrisEmploymentsPositiveResponseResult], next_: T.nilable(::String)).void }
