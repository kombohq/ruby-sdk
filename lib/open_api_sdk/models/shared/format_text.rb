  ...
  module Models
    module Shared
      ...
      class FormatText
        ...
        field :display_type, Crystalline::Nilable.new(Models::Shared::DisplayType1), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('display_type'), 'decoder': Utils.enum_from_string(Models::Shared::DisplayType1, true) } }
