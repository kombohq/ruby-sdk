  ...
  module Models
    module Shared
      ...
      class GetAtsJobsPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetAtsJobsPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetAtsJobsPositiveResponseResult], next_: T.nilable(::String)).void }
