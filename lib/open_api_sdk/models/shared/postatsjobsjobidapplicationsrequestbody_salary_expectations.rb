  ...
  module Models
    module Shared
      ...
      class PostAtsJobsJobIdApplicationsRequestBodySalaryExpectations
        ...
        field :period, Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyPeriod, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('period'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyPeriod, false) } }
