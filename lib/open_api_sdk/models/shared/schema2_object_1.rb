  ...
  module Models
    module Shared
      ...
      class Schema2Object1
        ...
        sig { params(label: ::String, required: T::Boolean, type: ::String, properties: Models::Shared::Schema1, description: T.nilable(::String), unified_key: T.nilable(Models::Shared::Schema2UnifiedKey6)).void }
