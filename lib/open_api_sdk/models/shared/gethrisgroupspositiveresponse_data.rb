  ...
  module Models
    module Shared
      ...
      class GetHrisGroupsPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetHrisGroupsPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetHrisGroupsPositiveResponseResult], next_: T.nilable(::String)).void }
