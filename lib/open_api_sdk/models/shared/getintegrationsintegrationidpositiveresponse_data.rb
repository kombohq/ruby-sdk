  ...
  module Models
    module Shared
      ...
      class GetIntegrationsIntegrationIdPositiveResponseData
        ...
        field :tool, Models::Shared::GetIntegrationsIntegrationIdPositiveResponseTool, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('tool'), required: true } }

        field :category, Models::Shared::GetIntegrationsIntegrationIdPositiveResponseCategory, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('category'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GetIntegrationsIntegrationIdPositiveResponseCategory, false) } }
        ...
        field :status, Models::Shared::GetIntegrationsIntegrationIdPositiveResponseStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GetIntegrationsIntegrationIdPositiveResponseStatus, false) } }
        ...
        field :setup_status, Models::Shared::GetIntegrationsIntegrationIdPositiveResponseSetupStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('setup_status'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GetIntegrationsIntegrationIdPositiveResponseSetupStatus, false) } }

        field :end_user, Models::Shared::GetIntegrationsIntegrationIdPositiveResponseEndUser, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('end_user'), required: true } }

        field :scope_config, Models::Shared::ScopeConfig, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('scope_config'), required: true } }
        ...
        field :read_models, Crystalline::Array.new(Models::Shared::GetIntegrationsIntegrationIdPositiveResponseReadModel), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('read_models'), required: true } }

        field :write_actions, Crystalline::Array.new(Models::Shared::GetIntegrationsIntegrationIdPositiveResponseWriteAction), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('write_actions'), required: true } }
