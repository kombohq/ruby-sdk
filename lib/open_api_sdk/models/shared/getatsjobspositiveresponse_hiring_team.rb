  ...
  module Models
    module Shared
      ...
      class GetAtsJobsPositiveResponseHiringTeam
        ...
        field :hiring_team_roles, Crystalline::Array.new(Models::Shared::GetAtsJobsPositiveResponseHiringTeamRole), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hiring_team_roles'), required: true } }
