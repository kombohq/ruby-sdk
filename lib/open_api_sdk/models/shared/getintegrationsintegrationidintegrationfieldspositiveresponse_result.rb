  ...
  module Models
    module Shared
      ...
      class GetIntegrationsIntegrationIdIntegrationFieldsPositiveResponseResult
        ...
        field :type, Models::Shared::GetIntegrationsIntegrationIdIntegrationFieldsPositiveResponseType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GetIntegrationsIntegrationIdIntegrationFieldsPositiveResponseType, false) } }
        ...
        sig { params(id: ::String, key: ::String, model: ::String, type: Models::Shared::GetIntegrationsIntegrationIdIntegrationFieldsPositiveResponseType, is_passthrough_enabled: T::Boolean, is_writable: T::Boolean, label: T.nilable(::String)).void }
