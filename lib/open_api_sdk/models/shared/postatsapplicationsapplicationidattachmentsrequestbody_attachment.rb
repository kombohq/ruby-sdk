  ...
  module Models
    module Shared
      ...
      class PostAtsApplicationsApplicationIdAttachmentsRequestBodyAttachment
        ...
        field :type, Models::Shared::PostAtsApplicationsApplicationIdAttachmentsRequestBodyType, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::PostAtsApplicationsApplicationIdAttachmentsRequestBodyType, false) } }
