  ...
  module Models
    module Shared
      ...
      class GetHrisEmployeesPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetHrisEmployeesPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetHrisEmployeesPositiveResponseResult], next_: T.nilable(::String)).void }
