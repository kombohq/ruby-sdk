  ...
  module Models
    module Shared
      ...
      class GetToolsCategoryPositiveResponseWriteActionField
        ...
        field :coverage_status, Models::Shared::GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('coverage_status'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus, false) } }
