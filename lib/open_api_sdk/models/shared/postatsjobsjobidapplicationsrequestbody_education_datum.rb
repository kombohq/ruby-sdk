  ...
  module Models
    module Shared
      ...
      class PostAtsJobsJobIdApplicationsRequestBodyEducationDatum
        ...
        field :field_of_study_reference, Crystalline::Nilable.new(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyFieldOfStudyReference), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Field_of_Study_Reference') } }

        field :degree_reference, Crystalline::Nilable.new(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyDegreeReference), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Degree_Reference') } }

        field :grade_average, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Grade_Average') } }

        sig { params(school_name: T.nilable(::String), first_year_attended: T.nilable(::Float), last_year_attended: T.nilable(::Float), field_of_study_reference: T.nilable(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyFieldOfStudyReference), degree_reference: T.nilable(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyDegreeReference), grade_average: T.nilable(::String)).void }
