  ...
  module Models
    module Shared
      ...
      class PostAtsApplicationsApplicationIdResultLinksRequestBodyOracle
        ...
        field :override_document_category, Crystalline::Nilable.new(Models::Shared::PostAtsApplicationsApplicationIdResultLinksRequestBodyOverrideDocumentCategory), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('override_document_category'), 'decoder': Utils.enum_from_string(Models::Shared::PostAtsApplicationsApplicationIdResultLinksRequestBodyOverrideDocumentCategory, true) } }
        ...
        sig { params(override_document_category: T.nilable(Models::Shared::PostAtsApplicationsApplicationIdResultLinksRequestBodyOverrideDocumentCategory), multi_post_to_all_current_applications: T.nilable(T::Boolean)).void }
