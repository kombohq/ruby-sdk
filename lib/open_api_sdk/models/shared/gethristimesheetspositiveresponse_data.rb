  ...
  module Models
    module Shared
      ...
      class GetHrisTimesheetsPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetHrisTimesheetsPositiveResponseResult), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('results'), required: true } }
