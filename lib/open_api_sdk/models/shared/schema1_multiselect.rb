  ...
  module Models
    module Shared
      ...
      class Schema1MultiSelect
        ...
        field :options, Crystalline::Union.new(Models::Shared::Schema1OptionsInline2, Models::Shared::Schema1OptionsReferenced2), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('options'), required: true } }
