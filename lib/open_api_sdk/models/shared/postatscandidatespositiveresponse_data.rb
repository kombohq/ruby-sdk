  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesPositiveResponseData
        ...
        field :applications, Crystalline::Array.new(Models::Shared::PostAtsCandidatesPositiveResponseApplication), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('applications'), required: true } }

        field :tags, Crystalline::Array.new(Models::Shared::PostAtsCandidatesPositiveResponseTag), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('tags'), required: true } }
        ...
        field :phone_numbers, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PostAtsCandidatesPositiveResponsePhoneNumber)), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('phone_numbers') } }
        # A list of email addresses of the candidate with an optional type. If an email address is invalid, it will be filtered out.
        field :email_addresses, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PostAtsCandidatesPositiveResponseEmailAddress)), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('email_addresses') } }
        # List of social media accounts of the candidate.
        field :social_media, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PostAtsCandidatesPositiveResponseSocialMedia)), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('social_media') } }
        # Location of the candidate.
        field :location, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesPositiveResponseLocation), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('location') } }
