  ...
  module Models
    module Shared
      ...
      class PostHrisAbsencesRequestBody
        ...
        field :unit, Crystalline::Nilable.new(Models::Shared::PostHrisAbsencesRequestBodyUnit), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unit'), 'decoder': Utils.enum_from_string(Models::Shared::PostHrisAbsencesRequestBodyUnit, true) } }
        ...
        field :remote_fields, Crystalline::Nilable.new(Models::Shared::PostHrisAbsencesRequestBodyRemoteFields), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('remote_fields') } }
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::PostHrisAbsencesRequestBodyStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::PostHrisAbsencesRequestBodyStatus, true) } }
