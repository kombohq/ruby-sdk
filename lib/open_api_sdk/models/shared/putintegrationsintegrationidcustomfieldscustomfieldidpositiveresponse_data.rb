  ...
  module Models
    module Shared
      ...
      class PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponseData
        ...
        field :integration_field, Crystalline::Nilable.new(Models::Shared::PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponseIntegrationField), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('integration_field'), required: true } }
        ...
        sig { params(id: ::String, key: ::String, model: ::String, integration_field: T.nilable(Models::Shared::PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponseIntegrationField), label: T.nilable(::String), description: T.nilable(::String)).void }
