  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesPositiveResponseApplication
        ...
        field :outcome, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesPositiveResponseOutcome), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('outcome'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::PostAtsCandidatesPositiveResponseOutcome, false) } }
        ...
        field :current_stage, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesPositiveResponseCurrentStage), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('current_stage'), required: true } }

        field :job, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesPositiveResponseJob), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('job'), required: true } }

        sig { params(id: ::String, changed_at: ::DateTime, remote_id: T.nilable(::String), outcome: T.nilable(Models::Shared::PostAtsCandidatesPositiveResponseOutcome), rejection_reason_name: T.nilable(::String), rejected_at: T.nilable(::DateTime), remote_url: T.nilable(::String), remote_created_at: T.nilable(::DateTime), remote_updated_at: T.nilable(::DateTime), current_stage: T.nilable(Models::Shared::PostAtsCandidatesPositiveResponseCurrentStage), job: T.nilable(Models::Shared::PostAtsCandidatesPositiveResponseJob)).void }
