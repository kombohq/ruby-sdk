  ...
  module Models
    module Shared
      ...
      class KomboAtsErrorError
        ...
        field :code, Crystalline::Nilable.new(Models::Shared::KomboAtsErrorCode), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::KomboAtsErrorCode, false) } }
        ...
        sig { params(message: ::String, code: T.nilable(Models::Shared::KomboAtsErrorCode), title: T.nilable(::String), log_url: T.nilable(::String)).void }
