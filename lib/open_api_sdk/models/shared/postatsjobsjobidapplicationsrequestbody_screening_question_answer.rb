  ...
  module Models
    module Shared
      ...
      class PostAtsJobsJobIdApplicationsRequestBodyScreeningQuestionAnswer
        ...
        field :answer, Crystalline::Union.new(::String, Crystalline::Boolean.new, ::Float, Crystalline::Array.new(::String), ::DateTime, Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyAnswer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('answer'), required: true } }

        sig { params(question_id: ::String, answer: T.any(::String, T::Boolean, ::Float, T::Array[::String], ::DateTime, Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyAnswer)).void }
