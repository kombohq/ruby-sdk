  ...
  module Models
    module Components
      ...
      class Schema2Object1
        ...
        field :properties, Models::Components::Schema1, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('properties'), required: true } }
        ...
        sig { params(label: ::String, required: T::Boolean, type: ::String, properties: Models::Components::Schema1, description: T.nilable(::String), unified_key: T.nilable(Models::Components::Schema2UnifiedKey6)).void }
