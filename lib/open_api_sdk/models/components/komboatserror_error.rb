  ...
  module Models
    module Components
      ...
      class KomboAtsErrorError
        ...
        field :code, Crystalline::Nilable.new(Models::Components::KomboAtsErrorCode), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': Utils.enum_from_string(Models::Components::KomboAtsErrorCode, false) } }
        ...
        sig { params(message: ::String, code: T.nilable(Models::Components::KomboAtsErrorCode), title: T.nilable(::String), log_url: T.nilable(::String)).void }
