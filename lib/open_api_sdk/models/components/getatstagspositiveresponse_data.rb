...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetAtsTagsPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Components::GetAtsTagsPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Components::GetAtsTagsPositiveResponseResult], next_: T.nilable(::String)).void }
