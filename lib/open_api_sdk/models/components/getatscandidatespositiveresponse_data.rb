...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetAtsCandidatesPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Components::GetAtsCandidatesPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Components::GetAtsCandidatesPositiveResponseResult], next_: T.nilable(::String)).void }
