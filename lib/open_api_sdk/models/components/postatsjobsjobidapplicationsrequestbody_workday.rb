...
module OpenApiSDK
  module Models
    module Components
      ...
      class PostAtsJobsJobIdApplicationsRequestBodyWorkday
        extend T::Sig
        include Crystalline::MetadataFields


        field :candidate_data, Crystalline::Nilable.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyCandidateData), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Candidate_Data') } }
        ...
        sig { params(candidate_data: T.nilable(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyCandidateData), override_source_reference_wid: T.nilable(::String)).void }
