  ...
  module Models
    module Components
      ...
      class PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponseIntegrationField
        ...
        field :type, Models::Components::PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponseType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponseType, false) } }
        ...
        sig { params(id: ::String, key: ::String, type: Models::Components::PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponseType, label: T.nilable(::String)).void }
