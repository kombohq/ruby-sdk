...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetHrisTimeOffBalancesPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Components::GetHrisTimeOffBalancesPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Components::GetHrisTimeOffBalancesPositiveResponseResult], next_: T.nilable(::String)).void }
