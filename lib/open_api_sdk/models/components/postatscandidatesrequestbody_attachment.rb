  ...
  module Models
    module Components
      ...
      class PostAtsCandidatesRequestBodyAttachment
        ...
        field :type, Models::Components::PostAtsCandidatesRequestBodyAttachmentType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::PostAtsCandidatesRequestBodyAttachmentType, false) } }
        ...
        sig { params(name: ::String, type: Models::Components::PostAtsCandidatesRequestBodyAttachmentType, content_type: T.nilable(::String), data_url: T.nilable(::String), data: T.nilable(::String)).void }
