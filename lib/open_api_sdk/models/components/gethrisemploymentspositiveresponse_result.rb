  ...
  module Models
    module Components
      ...
      class GetHrisEmploymentsPositiveResponseResult
        ...
        field :pay_rate, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_rate'), required: true } }
        ...
        field :pay_currency, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_currency'), required: true } }
        # The date of when the employment started.
        # https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString
        field :effective_date, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('effective_date'), required: true, 'decoder': Utils.datetime_from_iso_format(false) } }
        ...
        field :pay_period, Crystalline::Nilable.new(Models::Components::GetHrisEmploymentsPositiveResponsePayPeriod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_period'), 'decoder': Utils.enum_from_string(Models::Components::GetHrisEmploymentsPositiveResponsePayPeriod, true) } }
        ...
        field :pay_frequency, Crystalline::Nilable.new(Models::Components::GetHrisEmploymentsPositiveResponsePayFrequency), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_frequency'), 'decoder': Utils.enum_from_string(Models::Components::GetHrisEmploymentsPositiveResponsePayFrequency, true) } }
        ...
        field :employment_type, Crystalline::Nilable.new(Models::Components::GetHrisEmploymentsPositiveResponseEmploymentType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_type'), 'decoder': Utils.enum_from_string(Models::Components::GetHrisEmploymentsPositiveResponseEmploymentType, true) } }

        sig { params(id: ::String, employee_id: ::String, changed_at: ::DateTime, remote_id: T.nilable(::String), job_title: T.nilable(::String), pay_rate: T.nilable(::Float), pay_currency: T.nilable(::String), effective_date: T.nilable(::DateTime), remote_deleted_at: T.nilable(::DateTime), custom_fields: T.nilable(T::Hash[Symbol, ::Object]), pay_period: T.nilable(Models::Components::GetHrisEmploymentsPositiveResponsePayPeriod), pay_frequency: T.nilable(Models::Components::GetHrisEmploymentsPositiveResponsePayFrequency), employment_type: T.nilable(Models::Components::GetHrisEmploymentsPositiveResponseEmploymentType)).void }
