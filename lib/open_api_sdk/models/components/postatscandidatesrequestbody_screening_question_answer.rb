  ...
  module Models
    module Components
      ...
      class PostAtsCandidatesRequestBodyScreeningQuestionAnswer
        ...
        field :answer, Crystalline::Union.new(::String, Crystalline::Boolean.new, ::Float, Crystalline::Array.new(::String), ::DateTime, Models::Components::PostAtsCandidatesRequestBodyAnswer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('answer'), required: true } }

        sig { params(question_id: ::String, answer: T.any(::String, T::Boolean, ::Float, T::Array[::String], ::DateTime, Models::Components::PostAtsCandidatesRequestBodyAnswer)).void }
