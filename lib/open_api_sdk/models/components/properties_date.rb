  ...
  module Models
    module Components
      ...
      class PropertiesDate
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey3), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey3, true) } }

        sig { params(label: ::String, required: T::Boolean, type: ::String, description: T.nilable(::String), unified_key: T.nilable(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey3)).void }
