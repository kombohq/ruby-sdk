...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetAtsUsersPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Components::GetAtsUsersPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Components::GetAtsUsersPositiveResponseResult], next_: T.nilable(::String)).void }
