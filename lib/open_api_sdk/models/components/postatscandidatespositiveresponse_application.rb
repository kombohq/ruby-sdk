...
module OpenApiSDK
  module Models
    module Components
      ...
      class PostAtsCandidatesPositiveResponseApplication
        extend T::Sig
        ...
        field :outcome, Crystalline::Nilable.new(Models::Components::PostAtsCandidatesPositiveResponseOutcome), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('outcome'), required: true, 'decoder': Utils.enum_from_string(Models::Components::PostAtsCandidatesPositiveResponseOutcome, false) } }
        ...
        field :current_stage, Crystalline::Nilable.new(Models::Components::PostAtsCandidatesPositiveResponseCurrentStage), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('current_stage'), required: true } }

        field :job, Crystalline::Nilable.new(Models::Components::PostAtsCandidatesPositiveResponseJob), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('job'), required: true } }

        sig { params(id: ::String, changed_at: ::DateTime, remote_id: T.nilable(::String), outcome: T.nilable(Models::Components::PostAtsCandidatesPositiveResponseOutcome), rejection_reason_name: T.nilable(::String), rejected_at: T.nilable(::DateTime), remote_url: T.nilable(::String), remote_created_at: T.nilable(::DateTime), remote_updated_at: T.nilable(::DateTime), current_stage: T.nilable(Models::Components::PostAtsCandidatesPositiveResponseCurrentStage), job: T.nilable(Models::Components::PostAtsCandidatesPositiveResponseJob)).void }
