  ...
  module Models
    module Components
      ...
      class Manager
        ...
        field :employment_status, Crystalline::Nilable.new(Models::Components::ManagerEmploymentStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_status'), 'decoder': Utils.enum_from_string(Models::Components::ManagerEmploymentStatus, true) } }

        sig { params(id: ::String, remote_id: ::String, first_name: T.nilable(::String), last_name: T.nilable(::String), display_full_name: T.nilable(::String), employee_number: T.nilable(::String), termination_date: T.nilable(::DateTime), work_email: T.nilable(::String), employment_status: T.nilable(Models::Components::ManagerEmploymentStatus)).void }
