  ...
  module Models
    module Components
      ...
      class Schema1Object
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Components::Schema1UnifiedKey6), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Components::Schema1UnifiedKey6, true) } }

        sig { params(label: ::String, required: T::Boolean, type: ::String, properties: Models::Components::Schema1, description: T.nilable(::String), unified_key: T.nilable(Models::Components::Schema1UnifiedKey6)).void }
