  ...
  module Models
    module Components
      ...
      class Feature
        ...
        field :coverage_status, Models::Components::FeatureCoverageStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('coverage_status'), required: true, 'decoder': Utils.enum_from_string(Models::Components::FeatureCoverageStatus, false) } }

        sig { params(id: ::String, label: ::String, coverage_status: Models::Components::FeatureCoverageStatus).void }
