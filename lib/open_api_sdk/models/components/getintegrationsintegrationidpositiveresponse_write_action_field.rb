...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetIntegrationsIntegrationIdPositiveResponseWriteActionField
        extend T::Sig
        ...
        field :coverage_status, Models::Components::GetIntegrationsIntegrationIdPositiveResponseWriteActionFieldCoverageStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('coverage_status'), required: true, 'decoder': Utils.enum_from_string(Models::Components::GetIntegrationsIntegrationIdPositiveResponseWriteActionFieldCoverageStatus, false) } }

        sig { params(id: ::String, is_available: T::Boolean, coverage_status: Models::Components::GetIntegrationsIntegrationIdPositiveResponseWriteActionFieldCoverageStatus).void }
