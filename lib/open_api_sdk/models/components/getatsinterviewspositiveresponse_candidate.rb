...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetAtsInterviewsPositiveResponseCandidate
        extend T::Sig
        ...
        field :email_addresses, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::GetAtsInterviewsPositiveResponseEmailAddress)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('email_addresses') } }

        sig { params(id: ::String, remote_id: ::String, first_name: T.nilable(::String), last_name: T.nilable(::String), email_addresses: T.nilable(T::Array[Models::Components::GetAtsInterviewsPositiveResponseEmailAddress])).void }
