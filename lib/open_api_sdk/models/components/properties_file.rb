  ...
  module Models
    module Components
      ...
      class PropertiesFile
        ...
        field :file_restrictions, Models::Components::GetHrisEmployeesFormPositiveResponseFileRestrictions, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('file_restrictions'), required: true } }

        field :description, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('description') } }

        field :unified_key, Crystalline::Nilable.new(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey8), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey8, true) } }

        sig { params(label: ::String, required: T::Boolean, type: ::String, file_restrictions: Models::Components::GetHrisEmployeesFormPositiveResponseFileRestrictions, description: T.nilable(::String), unified_key: T.nilable(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey8)).void }
