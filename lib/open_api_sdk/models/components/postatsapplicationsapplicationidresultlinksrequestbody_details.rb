  ...
  module Models
    module Components
      ...
      class PostAtsApplicationsApplicationIdResultLinksRequestBodyDetails
        ...
        field :attributes, Crystalline::Array.new(Models::Components::PostAtsApplicationsApplicationIdResultLinksRequestBodyAttribute), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('attributes'), required: true } }

        sig { params(custom_field_name_prefix: ::String, attributes: T::Array[Models::Components::PostAtsApplicationsApplicationIdResultLinksRequestBodyAttribute]).void }
