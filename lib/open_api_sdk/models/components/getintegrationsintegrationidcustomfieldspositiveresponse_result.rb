...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetIntegrationsIntegrationIdCustomFieldsPositiveResponseResult
        extend T::Sig
        ...
        field :integration_field, Crystalline::Nilable.new(Models::Components::GetIntegrationsIntegrationIdCustomFieldsPositiveResponseIntegrationField), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('integration_field'), required: true } }
        ...
        sig { params(id: ::String, key: ::String, model: ::String, integration_field: T.nilable(Models::Components::GetIntegrationsIntegrationIdCustomFieldsPositiveResponseIntegrationField), label: T.nilable(::String), description: T.nilable(::String)).void }
