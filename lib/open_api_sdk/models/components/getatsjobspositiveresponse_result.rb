  ...
  module Models
    module Components
      ...
      class GetAtsJobsPositiveResponseResult
        ...
        field :stages, Crystalline::Array.new(Models::Components::Stage), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('stages'), required: true } }

        field :screening_questions, Crystalline::Array.new(Models::Components::ScreeningQuestion), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('screening_questions'), required: true } }

        field :job_postings, Crystalline::Array.new(Models::Components::JobPosting), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('job_postings'), required: true } }
        # The hiring team allows you to sync users into your system who can access the job and its applications.
        field :hiring_team, Crystalline::Array.new(Models::Components::GetAtsJobsPositiveResponseHiringTeam), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hiring_team'), required: true } }
        # Title of the job.
        ...
        field :employment_type, Crystalline::Nilable.new(Models::Components::GetAtsJobsPositiveResponseEmploymentType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_type'), 'decoder': Utils.enum_from_string(Models::Components::GetAtsJobsPositiveResponseEmploymentType, true) } }
        ...
        field :status, Crystalline::Nilable.new(Models::Components::GetAtsJobsPositiveResponseStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Components::GetAtsJobsPositiveResponseStatus, true) } }
        ...
        # 
        #  In rare cases where we can’t find a clear mapping, the original string is passed through.
        field :visibility, Crystalline::Nilable.new(Models::Components::Visibility), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('visibility'), 'decoder': Utils.enum_from_string(Models::Components::Visibility, true) } }
        # Defines if the job supports remote work and if so, to what extent.
        field :remote_work_status, Crystalline::Nilable.new(Models::Components::RemoteWorkStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('remote_work_status'), 'decoder': Utils.enum_from_string(Models::Components::RemoteWorkStatus, true) } }
        ...
        field :salary_period, Crystalline::Nilable.new(Models::Components::SalaryPeriod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('salary_period'), 'decoder': Utils.enum_from_string(Models::Components::SalaryPeriod, true) } }
        # The location of the listed job.
        field :location, Crystalline::Nilable.new(Models::Components::GetAtsJobsPositiveResponseLocation), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('location') } }

        sig { params(id: ::String, remote_id: ::String, changed_at: ::DateTime, stages: T::Array[Models::Components::Stage], screening_questions: T::Array[Models::Components::ScreeningQuestion], job_postings: T::Array[Models::Components::JobPosting], hiring_team: T::Array[Models::Components::GetAtsJobsPositiveResponseHiringTeam], name: T.nilable(::String), job_code: T.nilable(::String), description: T.nilable(::String), confidential: T.nilable(T::Boolean), weekly_hours: T.nilable(::Float), category: T.nilable(::String), department: T.nilable(::String), post_url: T.nilable(::String), experience_level: T.nilable(::String), salary_amount: T.nilable(::Float), salary_amount_from: T.nilable(::Float), salary_amount_to: T.nilable(::Float), salary_currency: T.nilable(::String), custom_fields: T.nilable(T::Hash[Symbol, ::Object]), remote_url: T.nilable(::String), opened_at: T.nilable(::DateTime), closed_at: T.nilable(::DateTime), remote_created_at: T.nilable(::DateTime), remote_updated_at: T.nilable(::DateTime), contact_id: T.nilable(::String), remote_deleted_at: T.nilable(::DateTime), employment_type: T.nilable(Models::Components::GetAtsJobsPositiveResponseEmploymentType), status: T.nilable(Models::Components::GetAtsJobsPositiveResponseStatus), visibility: T.nilable(Models::Components::Visibility), remote_work_status: T.nilable(Models::Components::RemoteWorkStatus), salary_period: T.nilable(Models::Components::SalaryPeriod), location: T.nilable(Models::Components::GetAtsJobsPositiveResponseLocation)).void }
