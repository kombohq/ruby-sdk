...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetAtsOffersPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Components::GetAtsOffersPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Components::GetAtsOffersPositiveResponseResult], next_: T.nilable(::String)).void }
