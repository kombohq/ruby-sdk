  ...
  module Models
    module Components
      ...
      class PostHrisEmployeesFormPositiveResponseData
        ...
        field :prehire, Models::Components::Prehire, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('prehire'), required: true } }
        ...
        sig { params(prehire: Models::Components::Prehire, id: T.nilable(::String), remote_id: T.nilable(::String)).void }
