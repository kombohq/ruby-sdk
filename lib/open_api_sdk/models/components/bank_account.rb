  ...
  module Models
    module Components
      ...
      class BankAccount
        ...
        field :domestic_bank_routing, Crystalline::Nilable.new(Models::Components::DomesticBankRouting), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('domestic_bank_routing') } }

        sig { params(iban: T.nilable(::String), bic: T.nilable(::String), account_number: T.nilable(::String), holder_name: T.nilable(::String), bank_name: T.nilable(::String), domestic_bank_routing: T.nilable(Models::Components::DomesticBankRouting)).void }
