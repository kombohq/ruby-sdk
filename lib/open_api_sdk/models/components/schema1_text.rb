  ...
  module Models
    module Components
      ...
      class Schema1Text
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Components::Schema1UnifiedKey1), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Components::Schema1UnifiedKey1, true) } }
        ...
        sig { params(label: ::String, required: T::Boolean, type: ::String, description: T.nilable(::String), unified_key: T.nilable(Models::Components::Schema1UnifiedKey1), min_length: T.nilable(::Float), max_length: T.nilable(::Float), reg_exp: T.nilable(::String)).void }
