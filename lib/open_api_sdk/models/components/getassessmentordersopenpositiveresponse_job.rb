  ...
  module Models
    module Components
      ...
      class GetAssessmentOrdersOpenPositiveResponseJob
        ...
        field :hiring_team, Crystalline::Array.new(Models::Components::GetAssessmentOrdersOpenPositiveResponseHiringTeam), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hiring_team'), required: true } }
        ...
        field :location, Crystalline::Nilable.new(Models::Components::GetAssessmentOrdersOpenPositiveResponseLocation), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('location') } }

        sig { params(hiring_team: T::Array[Models::Components::GetAssessmentOrdersOpenPositiveResponseHiringTeam], remote_id: T.nilable(::String), name: T.nilable(::String), location: T.nilable(Models::Components::GetAssessmentOrdersOpenPositiveResponseLocation)).void }
