  ...
  module Models
    module Components
      ...
      class KomboHrisErrorError
        ...
        field :code, Crystalline::Nilable.new(Models::Components::KomboHrisErrorCode), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': Utils.enum_from_string(Models::Components::KomboHrisErrorCode, false) } }
        ...
        sig { params(message: ::String, code: T.nilable(Models::Components::KomboHrisErrorCode), title: T.nilable(::String), log_url: T.nilable(::String)).void }
