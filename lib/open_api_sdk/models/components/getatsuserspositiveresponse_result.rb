  ...
  module Models
    module Components
      ...
      class GetAtsUsersPositiveResponseResult
        ...
        field :status, Crystalline::Nilable.new(Models::Components::GetAtsUsersPositiveResponseStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), required: true, 'decoder': Utils.enum_from_string(Models::Components::GetAtsUsersPositiveResponseStatus, false) } }
        ...
        sig { params(id: ::String, changed_at: ::DateTime, remote_id: T.nilable(::String), first_name: T.nilable(::String), last_name: T.nilable(::String), status: T.nilable(Models::Components::GetAtsUsersPositiveResponseStatus), remote_deleted_at: T.nilable(::DateTime), email: T.nilable(::String)).void }
