...
module OpenApiSDK
  module Models
    module Components
      ...
      class PostAtsJobsJobIdApplicationsRequestBodyLocationData
        extend T::Sig
        ...
        field :country_region_reference, Crystalline::Nilable.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyCountryRegionReference), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Country_Region_Reference') } }

        field :country_city_reference, Crystalline::Nilable.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyCountryCityReference), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('Country_City_Reference') } }

        sig { params(address_line_1: T.nilable(::String), address_line_2: T.nilable(::String), region_subdivision_1: T.nilable(::String), country_region_reference: T.nilable(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyCountryRegionReference), country_city_reference: T.nilable(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyCountryCityReference)).void }
