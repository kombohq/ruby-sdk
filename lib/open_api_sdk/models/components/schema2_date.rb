  ...
  module Models
    module Components
      ...
      class Schema2Date
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Components::Schema2UnifiedKey3), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Components::Schema2UnifiedKey3, true) } }

        sig { params(label: ::String, required: T::Boolean, type: ::String, description: T.nilable(::String), unified_key: T.nilable(Models::Components::Schema2UnifiedKey3)).void }
