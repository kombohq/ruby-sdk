...
module OpenApiSDK
  module Models
    module Components
      # GetToolsCategoryPositiveResponseReadModelCoverageStatus - The status of a datapoint of an integrated tool:
      # 
      ...
      class GetToolsCategoryPositiveResponseReadModelCoverageStatus < T::Enum
