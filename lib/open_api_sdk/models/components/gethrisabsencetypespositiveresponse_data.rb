...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetHrisAbsenceTypesPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Components::GetHrisAbsenceTypesPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Components::GetHrisAbsenceTypesPositiveResponseResult], next_: T.nilable(::String)).void }
