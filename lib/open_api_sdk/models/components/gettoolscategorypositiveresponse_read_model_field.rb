  ...
  module Models
    module Components
      ...
      class GetToolsCategoryPositiveResponseReadModelField
        ...
        field :coverage_status, Models::Components::GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('coverage_status'), required: true, 'decoder': Utils.enum_from_string(Models::Components::GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus, false) } }

        sig { params(id: ::String, coverage_status: Models::Components::GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus).void }
