...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetAtsJobsPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Components::GetAtsJobsPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Components::GetAtsJobsPositiveResponseResult], next_: T.nilable(::String)).void }
