  ...
  module Models
    module Components
      ...
      class GetToolsCategoryPositiveResponseTool
        ...
        field :assets, Models::Components::Assets, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('assets'), required: true } }
        # This describes the supported models and actions of this tool.
        field :coverage, Models::Components::Coverage, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('coverage'), required: true } }
        ...
        sig { params(id: ::String, label: ::String, assets: Models::Components::Assets, coverage: Models::Components::Coverage, internal_label: T.nilable(::String), paid_api_details_markdown: T.nilable(::String), fast_track_details_markdown: T.nilable(::String), partner_only_details_markdown: T.nilable(::String), connection_guide_url: T.nilable(::String)).void }
