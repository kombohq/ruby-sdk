  ...
  module Models
    module Components
      ...
      class Employment
        ...
        field :pay_period, Crystalline::Nilable.new(Models::Components::GetHrisEmployeesPositiveResponsePayPeriod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_period'), 'decoder': Utils.enum_from_string(Models::Components::GetHrisEmployeesPositiveResponsePayPeriod, true) } }
        ...
        field :pay_frequency, Crystalline::Nilable.new(Models::Components::GetHrisEmployeesPositiveResponsePayFrequency), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_frequency'), 'decoder': Utils.enum_from_string(Models::Components::GetHrisEmployeesPositiveResponsePayFrequency, true) } }
        ...
        field :employment_type, Crystalline::Nilable.new(Models::Components::EmploymentEmploymentType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_type'), 'decoder': Utils.enum_from_string(Models::Components::EmploymentEmploymentType, true) } }

        sig { params(id: ::String, employee_id: ::String, changed_at: ::DateTime, remote_id: T.nilable(::String), job_title: T.nilable(::String), pay_rate: T.nilable(::Float), pay_currency: T.nilable(::String), effective_date: T.nilable(::DateTime), remote_deleted_at: T.nilable(::DateTime), custom_fields: T.nilable(T::Hash[Symbol, ::Object]), pay_period: T.nilable(Models::Components::GetHrisEmployeesPositiveResponsePayPeriod), pay_frequency: T.nilable(Models::Components::GetHrisEmployeesPositiveResponsePayFrequency), employment_type: T.nilable(Models::Components::EmploymentEmploymentType)).void }
