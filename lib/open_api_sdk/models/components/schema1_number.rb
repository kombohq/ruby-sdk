  ...
  module Models
    module Components
      ...
      class Schema1Number
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Components::Schema1UnifiedKey2), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Components::Schema1UnifiedKey2, true) } }
        ...
        sig { params(label: ::String, required: T::Boolean, type: ::String, description: T.nilable(::String), unified_key: T.nilable(Models::Components::Schema1UnifiedKey2), min: T.nilable(::Float), max: T.nilable(::Float)).void }
