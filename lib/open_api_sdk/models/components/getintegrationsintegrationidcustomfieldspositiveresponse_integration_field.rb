  ...
  module Models
    module Components
      ...
      class GetIntegrationsIntegrationIdCustomFieldsPositiveResponseIntegrationField
        ...
        field :type, Models::Components::GetIntegrationsIntegrationIdCustomFieldsPositiveResponseType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::GetIntegrationsIntegrationIdCustomFieldsPositiveResponseType, false) } }
        ...
        sig { params(id: ::String, key: ::String, type: Models::Components::GetIntegrationsIntegrationIdCustomFieldsPositiveResponseType, label: T.nilable(::String)).void }
