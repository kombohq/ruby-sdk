  ...
  module Models
    module Components
      ...
      class GetIntegrationsIntegrationIdPositiveResponseReadModel
        ...
        field :coverage_status, Models::Components::GetIntegrationsIntegrationIdPositiveResponseReadModelCoverageStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('coverage_status'), required: true, 'decoder': Utils.enum_from_string(Models::Components::GetIntegrationsIntegrationIdPositiveResponseReadModelCoverageStatus, false) } }
        # The setting of the datapoint in the scope config that you configured in the Kombo dashboard.
        field :scope_config_setting, Models::Components::ReadModelScopeConfigSetting, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('scope_config_setting'), required: true, 'decoder': Utils.enum_from_string(Models::Components::ReadModelScopeConfigSetting, false) } }
        ...
        field :fields_, Crystalline::Array.new(Models::Components::GetIntegrationsIntegrationIdPositiveResponseReadModelField), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('fields'), required: true } }

        sig { params(id: ::String, label: ::String, is_available: T::Boolean, coverage_status: Models::Components::GetIntegrationsIntegrationIdPositiveResponseReadModelCoverageStatus, scope_config_setting: Models::Components::ReadModelScopeConfigSetting, opted_out_by_customer: T::Boolean, fields_: T::Array[Models::Components::GetIntegrationsIntegrationIdPositiveResponseReadModelField]).void }
