...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetAtsCandidatesCandidateIdAttachmentsPositiveResponseResult
        extend T::Sig
        ...
        field :candidate_id, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('candidate_id'), required: true } }

        field :type, Models::Components::GetAtsCandidatesCandidateIdAttachmentsPositiveResponseType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::GetAtsCandidatesCandidateIdAttachmentsPositiveResponseType, false) } }
        ...
        sig { params(id: ::String, candidate_id: ::String, type: Models::Components::GetAtsCandidatesCandidateIdAttachmentsPositiveResponseType, remote_id: ::String, data_url: ::String, file_name: ::String, content_type: ::String, application_id: T.nilable(::String), remote_created_at: T.nilable(::DateTime), remote_updated_at: T.nilable(::DateTime)).void }
