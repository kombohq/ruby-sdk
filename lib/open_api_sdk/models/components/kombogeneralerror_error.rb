  ...
  module Models
    module Components
      ...
      class KomboGeneralErrorError
        ...
        field :code, Crystalline::Nilable.new(Models::Components::KomboGeneralErrorCode), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': Utils.enum_from_string(Models::Components::KomboGeneralErrorCode, false) } }
        ...
        sig { params(message: ::String, code: T.nilable(Models::Components::KomboGeneralErrorCode), title: T.nilable(::String), log_url: T.nilable(::String)).void }
