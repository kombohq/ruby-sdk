  ...
  module Models
    module Components
      ...
      class PostAtsCandidatesCandidateIdResultLinksRequestBodyDetails
        ...
        field :attributes, Crystalline::Array.new(Models::Components::PostAtsCandidatesCandidateIdResultLinksRequestBodyAttribute), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('attributes'), required: true } }

        sig { params(custom_field_name_prefix: ::String, attributes: T::Array[Models::Components::PostAtsCandidatesCandidateIdResultLinksRequestBodyAttribute]).void }
