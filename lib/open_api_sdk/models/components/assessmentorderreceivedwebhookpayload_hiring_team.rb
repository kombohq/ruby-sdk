...
module OpenApiSDK
  module Models
    module Components
      ...
      class AssessmentOrderReceivedWebhookPayloadHiringTeam
        extend T::Sig
        ...
        field :hiring_team_roles, Crystalline::Array.new(Models::Components::AssessmentOrderReceivedWebhookPayloadHiringTeamRole), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hiring_team_roles'), required: true } }
        ...
        sig { params(remote_id: ::String, hiring_team_roles: T::Array[Models::Components::AssessmentOrderReceivedWebhookPayloadHiringTeamRole], email: T.nilable(::String), first_name: T.nilable(::String), last_name: T.nilable(::String)).void }
