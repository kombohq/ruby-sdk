...
module OpenApiSDK
  module Models
    module Components
      # GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus - The status of a datapoint of an integrated tool:
      # 
      ...
      class GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus < T::Enum
