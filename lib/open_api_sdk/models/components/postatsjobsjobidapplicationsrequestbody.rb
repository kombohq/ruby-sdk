  ...
  module Models
    module Components
      ...
      class PostAtsJobsJobIdApplicationsRequestBody
        ...
        field :candidate, Models::Components::PostAtsJobsJobIdApplicationsRequestBodyCandidate, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('candidate'), required: true } }
        ...
        field :attachments, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyAttachment)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('attachments') } }
        ...
        field :source, Crystalline::Nilable.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodySource), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('source') } }
        ...
        field :sourced_by, Crystalline::Nilable.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodySourcedBy), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('sourced_by') } }
        # Optional GDPR consent information required in some jurisdictions (like the Czech Republic or Slovakia).
        field :gdpr_consent, Crystalline::Nilable.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyGdprConsent), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('gdpr_consent') } }
        # Additional fields that we will pass through to specific ATS systems.
        field :remote_fields, Crystalline::Nilable.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyRemoteFields), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('remote_fields') } }
        ...
        field :screening_question_answers, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyScreeningQuestionAnswer)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('screening_question_answers') } }

        sig { params(candidate: Models::Components::PostAtsJobsJobIdApplicationsRequestBodyCandidate, stage_id: T.nilable(::String), attachments: T.nilable(T::Array[Models::Components::PostAtsJobsJobIdApplicationsRequestBodyAttachment]), source: T.nilable(Models::Components::PostAtsJobsJobIdApplicationsRequestBodySource), sourced_by: T.nilable(Models::Components::PostAtsJobsJobIdApplicationsRequestBodySourcedBy), gdpr_consent: T.nilable(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyGdprConsent), remote_fields: T.nilable(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyRemoteFields), screening_question_answers: T.nilable(T::Array[Models::Components::PostAtsJobsJobIdApplicationsRequestBodyScreeningQuestionAnswer])).void }
