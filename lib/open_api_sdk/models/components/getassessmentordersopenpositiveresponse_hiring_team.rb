  ...
  module Models
    module Components
      ...
      class GetAssessmentOrdersOpenPositiveResponseHiringTeam
        ...
        field :hiring_team_roles, Crystalline::Array.new(Models::Components::GetAssessmentOrdersOpenPositiveResponseHiringTeamRole), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hiring_team_roles'), required: true } }
        ...
        sig { params(remote_id: ::String, hiring_team_roles: T::Array[Models::Components::GetAssessmentOrdersOpenPositiveResponseHiringTeamRole], email: T.nilable(::String), first_name: T.nilable(::String), last_name: T.nilable(::String)).void }
