...
class OpenApiSDK::Models::Components::PostAtsJobsJobIdApplicationsRequestBodyRemoteFields
...
class OpenApiSDK::Models::Components::PostAtsJobsJobIdApplicationsRequestBodyRemoteFields
  ...
  def personio(); end
  def personio=(str_); end
  def talentsoft(); end
  def talentsoft=(str_); end
  def teamtailor(); end
  ...
  def zohorecruit(); end
  def zohorecruit=(str_); end
  def bullhorn(); end
  def bullhorn=(str_); end
  def smartrecruiters(); end
  def smartrecruiters=(str_); end
  def talentadore(); end
  def talentadore=(str_); end
  def guidecom(); end
  def guidecom=(str_); end
  def dvinci(); end
  def dvinci=(str_); end
  def hrworks(); end
  def hrworks=(str_); end
  def jobylon(); end
  def jobylon=(str_); end
  def avature(); end
