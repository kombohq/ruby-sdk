...
module OpenApiSDK
  module Models
    module Components
      ...
      class PostAtsCandidatesRequestBodySalaryExpectations
        extend T::Sig
        include Crystalline::MetadataFields

        # The period of the salary expectations. Must be one of `MONTH` or `YEAR`.
        field :period, Models::Components::PostAtsCandidatesRequestBodyPeriod, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('period'), required: true, 'decoder': Utils.enum_from_string(Models::Components::PostAtsCandidatesRequestBodyPeriod, false) } }
        ...
        sig { params(period: Models::Components::PostAtsCandidatesRequestBodyPeriod, amount: ::Float).void }
