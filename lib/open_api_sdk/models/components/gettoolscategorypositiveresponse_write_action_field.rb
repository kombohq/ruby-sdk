...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetToolsCategoryPositiveResponseWriteActionField
        extend T::Sig
        ...
        field :coverage_status, Models::Components::GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('coverage_status'), required: true, 'decoder': Utils.enum_from_string(Models::Components::GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus, false) } }

        sig { params(id: ::String, coverage_status: Models::Components::GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus).void }
