...
module OpenApiSDK
  module Models
    module Components
      # GetIntegrationsIntegrationIdPositiveResponseWriteActionFieldCoverageStatus - The status of a datapoint of an integrated tool:
      # 
      ...
      class GetIntegrationsIntegrationIdPositiveResponseWriteActionFieldCoverageStatus < T::Enum
