  ...
  module Models
    module Components
      ...
      class GetHrisPerformanceReviewCyclesPositiveResponseResult
        ...
        # https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString
        field :review_period_start_date, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('review_period_start_date'), required: true, 'decoder': Utils.datetime_from_iso_format(false) } }
