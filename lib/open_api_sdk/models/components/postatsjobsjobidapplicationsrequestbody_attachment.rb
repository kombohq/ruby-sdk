...
module OpenApiSDK
  module Models
    module Components
      ...
      class PostAtsJobsJobIdApplicationsRequestBodyAttachment
        extend T::Sig
        ...
        field :type, Models::Components::PostAtsJobsJobIdApplicationsRequestBodyAttachmentType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::PostAtsJobsJobIdApplicationsRequestBodyAttachmentType, false) } }
        ...
        sig { params(name: ::String, type: Models::Components::PostAtsJobsJobIdApplicationsRequestBodyAttachmentType, content_type: T.nilable(::String), data_url: T.nilable(::String), data: T.nilable(::String)).void }
