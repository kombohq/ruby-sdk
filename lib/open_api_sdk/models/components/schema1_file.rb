  ...
  module Models
    module Components
      ...
      class Schema1File
        ...
        field :file_restrictions, Models::Components::Schema1FileRestrictions, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('file_restrictions'), required: true } }

        field :description, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('description') } }

        field :unified_key, Crystalline::Nilable.new(Models::Components::Schema1UnifiedKey8), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Components::Schema1UnifiedKey8, true) } }

        sig { params(label: ::String, required: T::Boolean, type: ::String, file_restrictions: Models::Components::Schema1FileRestrictions, description: T.nilable(::String), unified_key: T.nilable(Models::Components::Schema1UnifiedKey8)).void }
