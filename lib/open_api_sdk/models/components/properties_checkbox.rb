  ...
  module Models
    module Components
      ...
      class PropertiesCheckbox
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey5), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey5, true) } }

        sig { params(label: ::String, required: T::Boolean, type: ::String, description: T.nilable(::String), unified_key: T.nilable(Models::Components::GetHrisEmployeesFormPositiveResponseUnifiedKey5)).void }
