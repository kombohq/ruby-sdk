  ...
  module Models
    module Components
      ...
      class GetAtsCandidatesPositiveResponseApplication
        ...
        field :outcome, Crystalline::Nilable.new(Models::Components::GetAtsCandidatesPositiveResponseOutcome), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('outcome'), required: true, 'decoder': Utils.enum_from_string(Models::Components::GetAtsCandidatesPositiveResponseOutcome, false) } }
        ...
        field :current_stage, Crystalline::Nilable.new(Models::Components::GetAtsCandidatesPositiveResponseCurrentStage), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('current_stage'), required: true } }

        field :job, Crystalline::Nilable.new(Models::Components::GetAtsCandidatesPositiveResponseJob), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('job'), required: true } }

        sig { params(id: ::String, changed_at: ::DateTime, remote_id: T.nilable(::String), outcome: T.nilable(Models::Components::GetAtsCandidatesPositiveResponseOutcome), rejection_reason_name: T.nilable(::String), rejected_at: T.nilable(::DateTime), remote_url: T.nilable(::String), remote_created_at: T.nilable(::DateTime), remote_updated_at: T.nilable(::DateTime), current_stage: T.nilable(Models::Components::GetAtsCandidatesPositiveResponseCurrentStage), job: T.nilable(Models::Components::GetAtsCandidatesPositiveResponseJob)).void }
