  ...
  module Models
    module Components
      ...
      class PostPassthroughToolApiRequestBody
        ...
        field :method, Models::Components::Method, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('method'), required: true, 'decoder': Utils.enum_from_string(Models::Components::Method, false) } }
        ...
        field :multipart_form_data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Components::MultipartFormDatum)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('multipart_form_data') } }
        ...
        sig { params(method: Models::Components::Method, path: ::String, headers: T.nilable(T::Hash[Symbol, ::String]), params: T.nilable(T::Hash[Symbol, ::String]), data: T.nilable(::Object), response_as_base64: T.nilable(T::Boolean), multipart_form_data: T.nilable(T::Array[Models::Components::MultipartFormDatum]), api_options: T.nilable(T::Hash[Symbol, ::String])).void }
