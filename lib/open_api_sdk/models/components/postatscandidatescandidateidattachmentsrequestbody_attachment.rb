  ...
  module Models
    module Components
      ...
      class PostAtsCandidatesCandidateIdAttachmentsRequestBodyAttachment
        ...
        field :type, Models::Components::PostAtsCandidatesCandidateIdAttachmentsRequestBodyType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::PostAtsCandidatesCandidateIdAttachmentsRequestBodyType, false) } }
        ...
        sig { params(name: ::String, type: Models::Components::PostAtsCandidatesCandidateIdAttachmentsRequestBodyType, content_type: T.nilable(::String), data_url: T.nilable(::String), data: T.nilable(::String)).void }
