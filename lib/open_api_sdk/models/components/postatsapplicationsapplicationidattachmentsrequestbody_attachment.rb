...
module OpenApiSDK
  module Models
    module Components
      ...
      class PostAtsApplicationsApplicationIdAttachmentsRequestBodyAttachment
        extend T::Sig
        ...
        field :type, Models::Components::PostAtsApplicationsApplicationIdAttachmentsRequestBodyType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::PostAtsApplicationsApplicationIdAttachmentsRequestBodyType, false) } }
        ...
        sig { params(name: ::String, type: Models::Components::PostAtsApplicationsApplicationIdAttachmentsRequestBodyType, content_type: T.nilable(::String), data_url: T.nilable(::String), data: T.nilable(::String)).void }
