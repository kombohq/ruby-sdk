...
module OpenApiSDK
  module Models
    module Components
      ...
      class GetAtsApplicationsPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Components::GetAtsApplicationsPositiveResponseResult), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Components::GetAtsApplicationsPositiveResponseResult], next_: T.nilable(::String)).void }
