  ...
  module Models
    module Webhooks
      ...
      class WebhookDataChangedWebhookPayloadRequest
        ...
        field :body, Models::Shared::DataChangedWebhookPayload, { 'request': { 'media_type': 'application/json' } }

        sig { params(x_kombo_signature: ::String, body: Models::Shared::DataChangedWebhookPayload).void }
