  ...
  module Models
    module Operations
      ...
      class PostAtsCandidatesCandidateIdTagsRequest
        ...
        field :body, Models::Shared::PostAtsCandidatesCandidateIdTagsRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(candidate_id: ::String, body: Models::Shared::PostAtsCandidatesCandidateIdTagsRequestBody, integration_id: T.nilable(::String)).void }
