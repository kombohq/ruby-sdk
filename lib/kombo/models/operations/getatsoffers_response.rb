...
module Kombo
  module Models
    module Operations
      ...
      class GetAtsOffersResponse
        extend T::Sig
        include Crystalline::MetadataFields
        sig { returns(T.proc.returns(T.nilable(GetAtsOffersResponse))) }
        ...
        def initialize(content_type:, status_code:, raw_response:, get_ats_offers_positive_response: nil)
          ...
          @get_ats_offers_positive_response = get_ats_offers_positive_response
        end
        ...
        def ==(other)
          ...
          return false unless @get_ats_offers_positive_response == other.get_ats_offers_positive_response
          true
        end
