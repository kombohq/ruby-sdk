  ...
  module Models
    module Operations
      ...
      class GetHrisPayslipsRequest
        ...
        field :employee_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'query_param': { 'field_name': 'employee_ids', 'style': 'form', 'explode': false } }
        # Filter by a comma-separated list of payrun IDs.
        field :payrun_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'query_param': { 'field_name': 'payrun_ids', 'style': 'form', 'explode': false } }
        ...
        sig { params(integration_id: T.nilable(::String), cursor: T.nilable(::String), updated_after: T.nilable(::DateTime), ids: T.nilable(T::Array[::String]), remote_ids: T.nilable(T::Array[::String]), legal_entity_ids: T.nilable(T::Array[::String]), employee_ids: T.nilable(T::Array[::String]), payrun_ids: T.nilable(T::Array[::String]), page_size: T.nilable(::Integer), include_deleted: T.nilable(T::Boolean), ignore_unsupported_filters: T.nilable(T::Boolean)).void }
        def initialize(integration_id: nil, cursor: nil, updated_after: nil, ids: nil, remote_ids: nil, legal_entity_ids: nil, employee_ids: nil, payrun_ids: nil, page_size: 100, include_deleted: false, ignore_unsupported_filters: false)
        ...
        def ==(other)
          ...
          return false unless @employee_ids == other.employee_ids
          return false unless @payrun_ids == other.payrun_ids
