  ...
  module Models
    module Operations
      ...
      class GetHrisGroupsResponse
        ...
        sig { returns(T.proc.returns(T.nilable(GetHrisGroupsResponse))) }
        ...
        def initialize(content_type:, status_code:, raw_response:, get_hris_groups_positive_response: nil)
          ...
          @get_hris_groups_positive_response = get_hris_groups_positive_response
        end
        ...
        def ==(other)
          ...
          return false unless @get_hris_groups_positive_response == other.get_hris_groups_positive_response
          true
        end
