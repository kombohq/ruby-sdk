...
module Kombo
  module Models
    module Operations
      ...
      class GetHrisPerformanceReviewsRequest
        extend T::Sig
        ...
        field :types, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'query_param': { 'field_name': 'types', 'style': 'form', 'explode': false } }
        # Filter by a comma-separated list of review cycle IDs.
        field :review_cycle_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'query_param': { 'field_name': 'review_cycle_ids', 'style': 'form', 'explode': false } }
        # Filter by a comma-separated list of reviewee IDs.
        field :reviewee_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'query_param': { 'field_name': 'reviewee_ids', 'style': 'form', 'explode': false } }
        ...
        sig { params(integration_id: T.nilable(::String), cursor: T.nilable(::String), updated_after: T.nilable(::DateTime), ids: T.nilable(T::Array[::String]), remote_ids: T.nilable(T::Array[::String]), types: T.nilable(T::Array[::String]), review_cycle_ids: T.nilable(T::Array[::String]), reviewee_ids: T.nilable(T::Array[::String]), page_size: T.nilable(::Integer), include_deleted: T.nilable(T::Boolean), ignore_unsupported_filters: T.nilable(T::Boolean)).void }
        def initialize(integration_id: nil, cursor: nil, updated_after: nil, ids: nil, remote_ids: nil, types: nil, review_cycle_ids: nil, reviewee_ids: nil, page_size: 100, include_deleted: false, ignore_unsupported_filters: false)
        ...
        def ==(other)
          ...
          return false unless @review_cycle_ids == other.review_cycle_ids
          return false unless @reviewee_ids == other.reviewee_ids
