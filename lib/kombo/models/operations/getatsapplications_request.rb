  ...
  module Models
    module Operations
      ...
      class GetAtsApplicationsRequest
        ...
        field :job_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'query_param': { 'field_name': 'job_ids', 'style': 'form', 'explode': false } }
        ...
        field :job_remote_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'query_param': { 'field_name': 'job_remote_ids', 'style': 'form', 'explode': false } }
        ...
        field :current_stage_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'query_param': { 'field_name': 'current_stage_ids', 'style': 'form', 'explode': false } }
        ...
        sig { params(integration_id: T.nilable(::String), cursor: T.nilable(::String), updated_after: T.nilable(::DateTime), ids: T.nilable(T::Array[::String]), remote_ids: T.nilable(T::Array[::String]), outcomes: T.nilable(T::Array[::String]), job_ids: T.nilable(T::Array[::String]), job_remote_ids: T.nilable(T::Array[::String]), current_stage_ids: T.nilable(T::Array[::String]), remote_created_after: T.nilable(::DateTime), page_size: T.nilable(::Integer), include_deleted: T.nilable(T::Boolean), ignore_unsupported_filters: T.nilable(T::Boolean)).void }
        def initialize(integration_id: nil, cursor: nil, updated_after: nil, ids: nil, remote_ids: nil, outcomes: nil, job_ids: nil, job_remote_ids: nil, current_stage_ids: nil, remote_created_after: nil, page_size: 100, include_deleted: false, ignore_unsupported_filters: false)
        ...
        def ==(other)
          ...
          return false unless @outcomes == other.outcomes
          return false unless @job_ids == other.job_ids
          return false unless @job_remote_ids == other.job_remote_ids
          return false unless @current_stage_ids == other.current_stage_ids
