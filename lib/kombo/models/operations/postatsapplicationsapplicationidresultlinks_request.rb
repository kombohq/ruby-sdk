  ...
  module Models
    module Operations
      ...
      class PostAtsApplicationsApplicationIdResultLinksRequest
        ...
        field :body, Models::Shared::PostAtsApplicationsApplicationIdResultLinksRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(application_id: ::String, body: Models::Shared::PostAtsApplicationsApplicationIdResultLinksRequestBody, integration_id: T.nilable(::String)).void }
