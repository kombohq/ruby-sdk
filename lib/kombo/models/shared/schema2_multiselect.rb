  ...
  module Models
    module Shared
      ...
      class Schema2MultiSelect
        ...
        field :options, Crystalline::Union.new(Models::Shared::Schema2OptionsInline2, Models::Shared::Schema2OptionsReferenced2), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('options'), required: true } }
        ...
        sig { params(label: ::String, required: T::Boolean, options: T.any(Models::Shared::Schema2OptionsInline2, Models::Shared::Schema2OptionsReferenced2), type: ::String, description: T.nilable(::String), unified_key: T.nilable(::String), min_items: T.nilable(::Float), max_items: T.nilable(::Float)).void }
