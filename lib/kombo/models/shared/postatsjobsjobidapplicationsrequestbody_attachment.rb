  ...
  module Models
    module Shared
      ...
      class PostAtsJobsJobIdApplicationsRequestBodyAttachment
        ...
        field :type, Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyAttachmentType, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('type'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyAttachmentType, false) } }
        ...
        sig { params(name: ::String, type: Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyAttachmentType, content_type: T.nilable(::String), data_url: T.nilable(::String), data: T.nilable(::String)).void }
