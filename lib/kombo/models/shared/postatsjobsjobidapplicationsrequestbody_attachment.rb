  ...
  module Models
    module Shared
      ...
      class PostAtsJobsJobIdApplicationsRequestBodyAttachment
        ...
        field :type, Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyAttachmentType, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::PostAtsJobsJobIdApplicationsRequestBodyAttachmentType, false) } }
