  ...
  module Models
    module Shared
      ...
      class Schema2File
        ...
        field :file_restrictions, Models::Shared::Schema2FileRestrictions, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('file_restrictions'), required: true } }
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::Schema2UnifiedKey8), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unified_key'), 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::Schema2UnifiedKey8, true) } }

        sig { params(label: ::String, required: T::Boolean, file_restrictions: Models::Shared::Schema2FileRestrictions, type: ::String, description: T.nilable(::String), unified_key: T.nilable(Models::Shared::Schema2UnifiedKey8)).void }
