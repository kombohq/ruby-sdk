...
module Kombo
  module Models
    module Shared
      ...
      class PutAssessmentOrdersAssessmentOrderIdResultRequestBodyAttachment
        extend T::Sig
        ...
        sig { params(name: ::String, content_type: T.nilable(::String), data_url: T.nilable(::String), data: T.nilable(::String)).void }
