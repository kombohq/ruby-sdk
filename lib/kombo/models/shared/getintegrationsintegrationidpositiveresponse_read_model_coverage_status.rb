...
module Kombo
  module Models
    module Shared
      # GetIntegrationsIntegrationIdPositiveResponseReadModelCoverageStatus - The status of a datapoint of an integrated tool:
      # 
      ...
      class GetIntegrationsIntegrationIdPositiveResponseReadModelCoverageStatus < T::Enum
        enums do
