  ...
  module Models
    module Shared
      ...
      class KomboGeneralErrorError
        ...
        field :code, Crystalline::Nilable.new(Models::Shared::KomboGeneralErrorCode), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('code'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::KomboGeneralErrorCode, false) } }
