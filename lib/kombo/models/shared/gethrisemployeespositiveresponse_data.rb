  ...
  module Models
    module Shared
      ...
      class GetHrisEmployeesPositiveResponseData
        ...
        field :results, Crystalline::Array.new(Models::Shared::GetHrisEmployeesPositiveResponseResult), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('results'), required: true } }
