  ...
  module Models
    module Shared
      ...
      class GetHrisAbsencesPositiveResponseResult
        ...
        field :unit, Crystalline::Nilable.new(Models::Shared::GetHrisAbsencesPositiveResponseUnit), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unit'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::GetHrisAbsencesPositiveResponseUnit, false) } }
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::GetHrisAbsencesPositiveResponseStatus), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('status'), 'decoder': Utils.open_enum_from_string(Models::Shared::GetHrisAbsencesPositiveResponseStatus, true) } }
