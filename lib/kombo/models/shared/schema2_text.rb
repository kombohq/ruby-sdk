  ...
  module Models
    module Shared
      ...
      class Schema2Text
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::Schema2UnifiedKey1), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unified_key'), 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::Schema2UnifiedKey1, true) } }
