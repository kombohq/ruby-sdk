  ...
  module Models
    module Shared
      ...
      class GetToolsCategoryPositiveResponseWriteActionField
        ...
        field :coverage_status, Models::Shared::GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('coverage_status'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus, false) } }

        sig { params(id: ::String, coverage_status: Models::Shared::GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus).void }
