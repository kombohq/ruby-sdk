  ...
  module Models
    module Shared
      ...
      class InlineAssessmentOrderReceivedWebhookPayload
        ...
        field :type, Models::Shared::InlineAssessmentOrderReceivedWebhookPayloadType, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('type'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::InlineAssessmentOrderReceivedWebhookPayloadType, false) } }
