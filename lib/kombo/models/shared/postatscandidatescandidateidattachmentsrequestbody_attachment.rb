  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesCandidateIdAttachmentsRequestBodyAttachment
        ...
        field :type, Models::Shared::PostAtsCandidatesCandidateIdAttachmentsRequestBodyType, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('type'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::PostAtsCandidatesCandidateIdAttachmentsRequestBodyType, false) } }
