  ...
  module Models
    module Shared
      ...
      class PostAtsApplicationsApplicationIdAttachmentsRequestBodyAttachment
        ...
        field :type, Models::Shared::PostAtsApplicationsApplicationIdAttachmentsRequestBodyType, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('type'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::PostAtsApplicationsApplicationIdAttachmentsRequestBodyType, false) } }
        ...
        sig { params(name: ::String, type: Models::Shared::PostAtsApplicationsApplicationIdAttachmentsRequestBodyType, content_type: T.nilable(::String), data_url: T.nilable(::String), data: T.nilable(::String)).void }
