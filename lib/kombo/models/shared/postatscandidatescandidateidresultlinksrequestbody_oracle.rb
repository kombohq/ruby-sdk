  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesCandidateIdResultLinksRequestBodyOracle
        ...
        field :override_document_category, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesCandidateIdResultLinksRequestBodyOverrideDocumentCategory), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('override_document_category'), 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::PostAtsCandidatesCandidateIdResultLinksRequestBodyOverrideDocumentCategory, true) } }
        ...
        sig { params(override_document_category: T.nilable(Models::Shared::PostAtsCandidatesCandidateIdResultLinksRequestBodyOverrideDocumentCategory), multi_post_to_all_current_applications: T.nilable(T::Boolean)).void }
