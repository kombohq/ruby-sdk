  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesRequestBodyLocationData
        ...
        field :country_region_reference, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesRequestBodyCountryRegionReference), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('Country_Region_Reference') } }

        field :country_city_reference, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesRequestBodyCountryCityReference), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('Country_City_Reference') } }
