  ...
  module Models
    module Shared
      ...
      class GetIntegrationsIntegrationIdPositiveResponseReadModel
        ...
        field :coverage_status, Models::Shared::GetIntegrationsIntegrationIdPositiveResponseReadModelCoverageStatus, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('coverage_status'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::GetIntegrationsIntegrationIdPositiveResponseReadModelCoverageStatus, false) } }
        # The setting of the datapoint in the scope config that you configured in the Kombo dashboard.
        field :scope_config_setting, Models::Shared::ReadModelScopeConfigSetting, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('scope_config_setting'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::ReadModelScopeConfigSetting, false) } }
        ...
        field :fields_, Crystalline::Array.new(Models::Shared::GetIntegrationsIntegrationIdPositiveResponseReadModelField), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('fields'), required: true } }
