  ...
  module Models
    module Shared
      ...
      class GetIntegrationsIntegrationIdPositiveResponseData
        ...
        field :read_models, Crystalline::Array.new(Models::Shared::GetIntegrationsIntegrationIdPositiveResponseReadModel), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('read_models'), required: true } }
