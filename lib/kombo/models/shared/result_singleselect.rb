  ...
  module Models
    module Shared
      ...
      class ResultSingleSelect
        ...
        field :options, Crystalline::Array.new(Models::Shared::GetAtsScorecardsPositiveResponseOption1), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('options'), required: true } }
        ...
        field :answer, Crystalline::Nilable.new(Models::Shared::GetAtsScorecardsPositiveResponseAnswer1), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('answer'), required: true } }

        sig { params(label: ::String, options: T::Array[Models::Shared::GetAtsScorecardsPositiveResponseOption1], remote_id: T.nilable(::String), description: T.nilable(::String), required: T.nilable(T::Boolean), type: ::String, answer: T.nilable(Models::Shared::GetAtsScorecardsPositiveResponseAnswer1)).void }
        def initialize(label:, options:, remote_id: nil, description: nil, required: nil, type: 'SINGLE_SELECT', answer: nil)
          @label = label
          @options = options
          @remote_id = remote_id
