  ...
  module Models
    module Shared
      ...
      class GetAtsJobsPositiveResponseResult
        ...
        field :screening_questions, Crystalline::Array.new(Models::Shared::ScreeningQuestion), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('screening_questions'), required: true } }

        field :job_postings, Crystalline::Array.new(Models::Shared::JobPosting), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('job_postings'), required: true } }
        # The hiring team allows you to sync users into your system who can access the job and its applications.
        field :hiring_team, Crystalline::Array.new(Models::Shared::GetAtsJobsPositiveResponseHiringTeam), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('hiring_team'), required: true } }
        # Title of the job.
        ...
        field :category, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('category'), required: true } }
        ...
        field :department, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('department'), required: true } }
        # The public job posting URL of the ATS itself. This can be used by external job boards to redirect applicants.
        field :post_url, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('post_url'), required: true } }
        ...
        field :experience_level, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('experience_level'), required: true } }
        # The salary amount in the given currency.
        field :salary_amount, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('salary_amount'), required: true } }
        # The lower bound of the salary range.
        field :salary_amount_from, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('salary_amount_from'), required: true } }
        # The upper bound of the salary range.
        field :salary_amount_to, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('salary_amount_to'), required: true } }
        # Salary currency usually returned in [ISO 4217 currency codes](https://www.iso.org/iso-4217-currency-codes.html).
        field :salary_currency, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('salary_currency'), required: true } }
        ...
        #
        #  In rare cases where we can’t find a clear mapping, the original string is passed through.
        field :visibility, Crystalline::Nilable.new(Models::Shared::GetAtsJobsPositiveResponseVisibility), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('visibility'), 'decoder': ::Kombo::Utils.open_enum_from_string(Models::Shared::GetAtsJobsPositiveResponseVisibility, true) } }
