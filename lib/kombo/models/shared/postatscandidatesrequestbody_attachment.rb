  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesRequestBodyAttachment
        ...
        field :type, Models::Shared::PostAtsCandidatesRequestBodyAttachmentType, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::PostAtsCandidatesRequestBodyAttachmentType, false) } }
