...
module Kombo
  module Models
    module Shared
      # GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus - The status of a datapoint of an integrated tool:
      #
      ...
      class GetToolsCategoryPositiveResponseWriteActionFieldCoverageStatus < T::Enum
        enums do
