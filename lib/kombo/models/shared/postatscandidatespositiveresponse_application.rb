  ...
  module Models
    module Shared
      ...
      class PostAtsCandidatesPositiveResponseApplication
        ...
        field :outcome, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesPositiveResponseOutcome), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('outcome'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::PostAtsCandidatesPositiveResponseOutcome, false) } }
        ...
        field :current_stage, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesPositiveResponseCurrentStage), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('current_stage'), required: true } }

        field :job, Crystalline::Nilable.new(Models::Shared::PostAtsCandidatesPositiveResponseJob), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('job'), required: true } }
