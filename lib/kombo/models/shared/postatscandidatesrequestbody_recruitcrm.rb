...
module Kombo
  module Models
    module Shared
      ...
      class PostAtsCandidatesRequestBodyRecruitcrm
        extend T::Sig
        ...
        field :custom_fields, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PostAtsCandidatesRequestBodyCustomField)), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('custom_fields') } }

        sig { params(custom_fields: T.nilable(T::Array[Models::Shared::PostAtsCandidatesRequestBodyCustomField])).void }
