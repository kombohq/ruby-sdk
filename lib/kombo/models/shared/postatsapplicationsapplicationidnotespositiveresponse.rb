  ...
  module Models
    module Shared
      ...
      class PostAtsApplicationsApplicationIdNotesPositiveResponse
        ...
        sig { params(data: Models::Shared::PostAtsApplicationsApplicationIdNotesPositiveResponseData, warnings: T::Array[Models::Shared::PostAtsApplicationsApplicationIdNotesPositiveResponseWarning], status: ::String).void }
