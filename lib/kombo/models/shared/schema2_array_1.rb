  ...
  module Models
    module Shared
      ...
      class Schema2Array1
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::Schema2UnifiedKey7), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unified_key'), 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::Schema2UnifiedKey7, true) } }
        ...
        sig { params(label: ::String, required: T::Boolean, item_type: T.any(Models::Shared::Schema2Text, Models::Shared::Schema2Number, Models::Shared::Schema2Date, Models::Shared::Schema2SingleSelect, Models::Shared::Schema2MultiSelect, Models::Shared::Schema2Checkbox, Models::Shared::Schema2Object1, Models::Shared::Schema2Array1, Models::Shared::Schema2File), type: ::String, description: T.nilable(::String), unified_key: T.nilable(Models::Shared::Schema2UnifiedKey7), min_items: T.nilable(::Float), max_items: T.nilable(::Float)).void }
