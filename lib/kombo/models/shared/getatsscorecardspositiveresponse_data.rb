...
module Kombo
  module Models
    module Shared
      ...
      class GetAtsScorecardsPositiveResponseData
        extend T::Sig
        include Crystalline::MetadataFields


        field :results, Crystalline::Array.new(Models::Shared::GetAtsScorecardsPositiveResponseResult), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('results'), required: true } }
        ...
        sig { params(results: T::Array[Models::Shared::GetAtsScorecardsPositiveResponseResult], next_: T.nilable(::String)).void }
