  ...
  module Models
    module Shared
      ...
      class Schema1Checkbox
        ...
        field :unified_key, Crystalline::Nilable.new(Models::Shared::Schema1UnifiedKey5), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unified_key'), 'decoder': Utils.enum_from_string(Models::Shared::Schema1UnifiedKey5, true) } }
