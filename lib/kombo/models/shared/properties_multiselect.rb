  ...
  module Models
    module Shared
      ...
      class PropertiesMultiSelect
        ...
        field :options, Crystalline::Union.new(Models::Shared::GetHrisEmployeesFormPositiveResponseOptionsInline2, Models::Shared::GetHrisEmployeesFormPositiveResponseOptionsReferenced2), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('options'), required: true } }
        ...
        field :unified_key, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unified_key') } }
        ...
        sig { params(label: ::String, required: T::Boolean, options: T.any(Models::Shared::GetHrisEmployeesFormPositiveResponseOptionsInline2, Models::Shared::GetHrisEmployeesFormPositiveResponseOptionsReferenced2), type: ::String, description: T.nilable(::String), unified_key: T.nilable(::String), min_items: T.nilable(::Float), max_items: T.nilable(::Float)).void }
