  ...
  module Models
    module Shared
      ...
      class GetToolsCategoryPositiveResponseReadModelField
        ...
        field :coverage_status, Models::Shared::GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus, { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('coverage_status'), required: true, 'decoder': ::Kombo::Utils.enum_from_string(Models::Shared::GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus, false) } }
