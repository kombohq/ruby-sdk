  ...
  module Models
    module Shared
      ...
      class GetHrisTimesheetsPositiveResponseResult
        ...
        field :payable_hours, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('payable_hours'), required: true } }
        # Unpaid break in minutes - will be from the HRIS or calculated by Kombo if we have concrete unpaid break times.
        field :unpaid_break_minutes, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::Kombo::Utils.field_name('unpaid_break_minutes'), required: true } }
